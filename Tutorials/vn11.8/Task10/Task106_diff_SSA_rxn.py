...
cname='/umshared/Tutorials/vn11.8/sample_output/Task10.3/Task103_SSA.nc'
ename='/umshared/Tutorials/vn11.8/sample_output/Task10.6/Task106_SSA.nc'
...
# output to netCDF
iris.save(expt,'Task106_SSA_diff.nc',netcdf_format='NETCDF3_CLASSIC')
